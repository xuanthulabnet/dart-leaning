...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    HtmlElement: {
      "^": "Element;",
      "%": "HTMLAudioElement|HTMLBRElement|HTMLBaseElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFontElement|HTMLFrameElement|HTMLFrameSetElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLImageElement|HTMLInputElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMarqueeElement|HTMLMediaElement|HTMLMenuElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPictureElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLShadowElement|HTMLSlotElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableDataCellElement|HTMLTableElement|HTMLTableHeaderCellElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTemplateElement|HTMLTextAreaElement|HTMLTimeElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement|HTMLVideoElement;HTMLElement"
    },
    AnchorElement: {
      "^": "HtmlElement;",
      toString$0: function(receiver) {
      ...
      insertAdjacentElement$2: function(receiver, where, element) {
        ...
        if (!!receiver.insertAdjacentElement)
          ...
          switch (where.toLowerCase()) {
            case "beforebegin":
              J.insertBefore$2$x(receiver.parentNode, element, receiver);
              break;
            case "afterbegin":
              ...
              break;
            case "beforeend":
              this.append$1(receiver, element);
              break;
            case "afterend":
              J.insertBefore$2$x(receiver.parentNode, element, receiver.nextSibling);
              break;
            default:
    ...
    _ChildNodeListLazy: {
      ...
      addAll$1: function(_, iterable) {
        ...
        for (t1 = iterable.length, t2 = this._this, t3 = J.getInterceptor$x(t2), _i = 0; _i < iterable.length; iterable.length === t1 || (0, H.throwConcurrentModificationError)(iterable), ++_i)
    ...
    "^": ""
  }], ["dialog.alert", "package:dialog/dialogs/alert.dart",, U, {
    "^": "",
    alert: function(message) {
      var t1, t2, t3, t4, t5, t6, t7, alertDialog, link, t8, t9, dialogModal, dialogContent, dialogHeader, dialogTitle, dialogBody, dialogFooter;
      t1 = document;
      t2 = H.setRuntimeTypeInfo([t1.createTextNode(message)], [W.Node]);
      t3 = t1.createElement("div");
      t4 = t1.createElement("div");
      t5 = t1.createElement("button");
      t6 = t1.createElement("button");
      t7 = t1.createElement("button");
      alertDialog = new E.Dialog("Alert", t2, "OK", "Cancel", true, false, false, t3, t4, t5, t6, t7);
      if (C.HtmlDocument_methods.querySelector$1(t1, "body").style.color !== "rgb(51, 51, 51)") {
        t6 = W.Element;
        ...
        t6 = new W._FrozenElementList(C.HtmlDocument_methods._querySelectorAll$1(t1, "[href*='packages/dialog/bootstrap.css']"), [t6]);
        t6 = t6.get$length(t6) === 0;
      } else
        t6 = false;
      if (t6) {
        link = t1.createElement("link");
        link.href = "packages/dialog/bootstrap.css";
        link.rel = "stylesheet";
        link.type = "text/css";
        J.insertAdjacentElement$2$x(C.HtmlDocument_methods.querySelector$1(t1, "head"), "beforeEnd", link);
      }
      t6 = P.String;
      t8 = [t6];
      t6 = [t6];
      W._ElementCssClassSet__addAll(t3, H.assertSubtype(H.setRuntimeTypeInfo(["modal", "fade"], t8), "$isIterable", t6, "$asIterable"));
      t9 = t3.style;
      t9.display = "block";
      W._ElementCssClassSet__addAll(t4, H.assertSubtype(H.setRuntimeTypeInfo(["modal-backdrop", "fade"], t8), "$isIterable", t6, "$asIterable"));
      t9 = t4.style;
      t9.zIndex = "auto";
      C.DivElement_methods.append$1(t3, t4);
      dialogModal = t1.createElement("div");
      W._ElementCssClassSet__addAll(dialogModal, H.assertSubtype(H.setRuntimeTypeInfo(["modal-dialog", "modal-sm"], t8), "$isIterable", t6, "$asIterable"));
      C.DivElement_methods.append$1(t3, dialogModal);
      dialogContent = t1.createElement("div");
      dialogContent.classList.add("modal-content");
      C.DivElement_methods.append$1(dialogModal, dialogContent);
      dialogHeader = t1.createElement("div");
      dialogHeader.classList.add("modal-header");
      t9 = dialogHeader.style;
      t9.border = "0";
      dialogTitle = t1.createElement("h5");
      dialogTitle.classList.add("modal-title");
      dialogTitle.textContent = "Alert";
      C.DivElement_methods.append$1(dialogHeader, dialogTitle);
      t5.classList.add("close");
      t5.textContent = H.Primitives_stringFromCharCode(215);
      C.DivElement_methods.append$1(dialogHeader, t5);
      C.DivElement_methods.append$1(dialogContent, dialogHeader);
      dialogBody = t1.createElement("div");
      dialogBody.classList.add("modal-body");
      new W._ChildNodeListLazy(dialogBody).addAll$1(0, t2);
      t2 = dialogBody.style;
      t2.paddingBottom = "0";
      t2 = dialogBody.style;
      t2.paddingTop = "0";
      C.DivElement_methods.append$1(dialogContent, dialogBody);
      dialogFooter = t1.createElement("div");
      dialogFooter.classList.add("modal-footer");
      t2 = dialogFooter.style;
      t2.border = "0";
      W._ElementCssClassSet__addAll(t7, H.assertSubtype(H.setRuntimeTypeInfo(["btn", "btn-primary"], t8), "$isIterable", t6, "$asIterable"));
      t7.textContent = "OK";
      C.DivElement_methods.append$1(dialogFooter, t7);
      C.DivElement_methods.append$1(dialogContent, dialogFooter);
      t2 = t1.body;
      t5 = t2.classList.contains("modal-open");
      if (!t5) {
        (t2 && C.BodyElement_methods).append$1(t2, t3);
        t4.classList.add("show");
        t3.classList.add("show");
        t1.body.classList.add("modal-open");
      }
      t7.focus();
      t2 = new W._ElementEventStreamImpl(t4, "click", false, [W.MouseEvent]);
      t2.get$first(t2).then$1$1(new U.alert_closure(alertDialog), -1);
      t2 = W.Element;
      ...
      t2 = new W._FrozenElementList(C.HtmlDocument_methods._querySelectorAll$1(t1, ".modal button"), [t2]);
      t2.forEach$1(t2, new U.alert_closure0(alertDialog));
    },
    alert_closure: {
      "^": "Closure:5;alertDialog",
      call$1: function(_) {
        H.interceptedTypeCheck(_, "$isMouseEvent");
        return this.alertDialog.closeDialog$0();
      }
    },
    alert_closure0: {
      "^": "Closure:12;alertDialog",
      call$1: function(buttons) {
        var t1, t2, t3;
        H.interceptedTypeCheck(buttons, "$isElement");
        t1 = J.getInterceptor$x(buttons);
        t2 = t1.get$onClick(buttons);
        t3 = this.alertDialog;
        t2.get$first(t2).then$1$1(new U.alert__closure(t3), -1);
        t1 = t1.get$onKeyDown(buttons);
        t2 = H.getTypeArgumentByIndex(t1, 0);
        W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new U.alert__closure0(t3), {func: 1, ret: -1, args: [t2]}), false, t2);
      }
    },
    alert__closure: {
      "^": "Closure:5;alertDialog",
    ...
    alert__closure0: {
      "^": "Closure:13;alertDialog",
      call$1: function(e) {
        if (H.interceptedTypeCheck(e, "$isKeyboardEvent").keyCode === 27)
          this.alertDialog.closeDialog$0();
      }
    }
  }], ["dialog.src.dialog_class", "package:dialog/src/dialog_class.dart",, E, {
    "^": "",
    Dialog: {
      "^": "Object;title,content,successText,cancelText,onSuccess,onCancel,cancellable,dialog,dialogBackdrop,xButton,cancelButton,okButton",
      closeDialog$0: function() {
        var t1, t2;
        t1 = document.body;
        t2 = t1.classList.contains("modal-open");
        if (t2) {
          new W._ChildrenElementList(t1, t1.children).remove$1(0, this.dialog);
          new W._ChildrenElementList(t1, t1.children).remove$1(0, this.dialogBackdrop);
          t1.classList.remove("modal-open");
        }
      }
    }
  }], ["", "lib.dart",, G, {
    ...
    main: function() {
      var t1, t2;
      t1 = J.get$onClick$x(C.HtmlDocument_methods.querySelector$1(document, "#alertButton"));
      t2 = H.getTypeArgumentByIndex(t1, 0);
